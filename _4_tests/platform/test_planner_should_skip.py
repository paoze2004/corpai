...
"""
from _0_CorpAI._2_platform.orchestrator.planner import TaskPlanner, INDEPENDENT_INTENTS
...
class TestTaskPlannerShouldSkip:
    ...
    def test_single_known_intent_returns_true(self):
        ...
        assert self.planner.should_skip(["knowledge"]) is True
    ...
    def test_multiple_all_independent_returns_true(self):
        ...
        assert self.planner.should_skip(["hr", "devops", "knowledge"]) is True
