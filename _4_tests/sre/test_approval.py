...
from _0_CorpAI._2_platform.sre.approval import (
    REQUIRED_SCOPE,
    AlreadyDecided,
    ApprovalService,
    InsufficientScope,
...
class TestStorePendingPlan(unittest.TestCase):
    def test_returns_plan_id_and_token(self):
        ...
        with patch("_0_CorpAI._2_platform.db.DatabasePool.get", return_value=pool):
            svc = ApprovalService()
...
class TestApprove(unittest.TestCase):
    ...
    def _patch_pool(self, row, lastrowid=1):
        ...
        pool = _fake_pool(conn)
        return patch("_0_CorpAI._2_platform.db.DatabasePool.get", return_value=pool)
...
class TestReject(unittest.TestCase):
    ...
    def test_reject_token_mismatch(self):
        ...
        pool = _fake_pool(conn)
        with (
            patch("_0_CorpAI._2_platform.db.DatabasePool.get", return_value=pool),
