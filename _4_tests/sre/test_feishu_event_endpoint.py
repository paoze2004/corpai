...
with patch("_0_CorpAI._0_api.app.build_default_service") as _mock_svc, \
     patch("_0_CorpAI._0_api.app.discover_all", return_value=None):
    from fastapi.testclient import TestClient

    from _0_CorpAI._0_api.app import app
...
class TestFeishuEventEndpoint(unittest.TestCase):
    ...
    def test_card_action_trigger_approve(self):
        ...
        with patch("_0_CorpAI._0_api.app.handle_approve_callback") as mock_approve:
    ...
    def test_card_action_trigger_reject(self):
        ...
        with patch("_0_CorpAI._0_api.app.handle_reject_callback") as mock_reject:
    ...
    def test_signature_invalid_when_key_set(self):
        ...
        try:
            with patch(
                "_0_CorpAI._0_api.app.verify_signature", return_value=False,
            ):
