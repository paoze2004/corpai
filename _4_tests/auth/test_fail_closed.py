...
from _0_CorpAI._2_platform.auth.dependencies import get_jwt_secret, get_current_user, require_role
...
class TestFailClosed(unittest.TestCase):
    ...
    def test_audit_log_db_down_raises_500(self):
        ...
        with patch("_0_CorpAI._2_platform.db.DatabasePool.get") as mock_get:
