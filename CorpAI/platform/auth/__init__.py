...
公开 API(统一从此 import):
    from CorpAI.platform.auth import (
...
from CorpAI.platform.auth.scopes import ROLE_SCOPES, has_scope, scopes_for_role
from CorpAI.platform.auth.tokens import jwt_decode, jwt_encode, make_access_token
