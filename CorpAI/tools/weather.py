...
from CorpAI.config import Config  # 项目配置类，读取数据库/API 等配置信息
from CorpAI.logging import logger  # 日志记录器，统一输出运行日志
from CorpAI.utils.format import DateEncoder, default_encoder  # 自定义 JSON 编码器，处理 date/Decimal 等特殊类型
