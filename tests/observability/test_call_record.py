...
from CorpAI.platform.observability import call_record
from CorpAI.platform.observability.trace import Span
...
class TestWriteCallRecord(unittest.TestCase):
    ...
    def test_db_unreachable_logs_warning(self):
        ...
        from CorpAI.platform.observability.call_record import write_call_record
        ...
        with patch.object(call_record, "DatabasePool", new=FakeDatabasePool):
            with self.assertLogs(
                "CorpAI.observability", level="WARNING",
            ) as captured:
