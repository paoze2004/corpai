...
AGENT_MANIFEST = PluginManifest(
    ...
    required_intents=["knowledge"],
    permissions=["knowledge:read"],
    tags=["rag", "knowledge-base", "search", "milvus", "embedding"],
)

QUERY_TOOL = PluginManifest(
    name="knowledge_query_mcp",
    version="1.1.0",
    description="Milvus 语义检索 — query_knowledge(query_text, collection=None, limit=3)。",
    plugin_type="mcp_tool",
    endpoint="http://localhost:8030",
    mcp_tool_name="query_knowledge",
    permissions=["knowledge:read"],
