...
os.environ.setdefault("MYSQL_DB", "_0_CorpAI")
...
class TestHrE2E(unittest.TestCase):
    ...
    # ─── 6. cross_query_knowledge 兜底降级 ───

    def test_06_bridge_faq_fallback_when_unreachable(self):
        """faq 服务不可达时,cross_query_knowledge 返 success 但 hits 空(不阻塞主流程)。"""
        from hr_assistant import actions
        resp = json.loads(actions.cross_query_knowledge(
