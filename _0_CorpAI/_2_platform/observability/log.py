...
公开 API:
    ...
    setup_json_logger(name, log_file) — Phase 4 实现,_0_CorpAI/logging.py:setup_logger 委托给它
...
from _0_CorpAI._2_platform.observability.trace import current_span_id, current_trace_id
...
def setup_json_logger(name: str, log_file: str = "logs/app.log") -> logging.Logger:
    """Phase 4 实现 — 兼容 _0_CorpAI/logging.py:setup_logger 调用形态。
