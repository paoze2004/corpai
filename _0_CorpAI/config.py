...
# 项目根目录:config.py 在 _0_CorpAI/ 包内,向上两层回到项目根
...
class Config:
    ...
    def __init__(self) -> None:
        ...
        self.database = _env("MYSQL_DATABASE", "_0_CorpAI")
        ...
        self.knowledge_collection = _env("FAQ_COLLECTION", "knowledge_docs")  # Phase 5 faq plugin 加
