...
严格遵守规则：
- 支持意图：['hr' (HR 助手:年假/病假/缺勤/报销/福利/保险等人事问题), 'devops' (运维副驾:工单查询/On-call 联系/Pod 重启/告警/线上故障), 'knowledge' (企业知识库/制度文档/流程规范检索)] 或其组合（如 [intent1, intent2]）。如果意图超出这些范围，返回意图 'out_of_scope'。
