...
from faq.plugin import AGENT_MANIFEST, QUERY_TOOL, register
...
class TestPrompts(unittest.TestCase):
    def test_summarize_faq(self):
        from faq.prompts import FAQ_LLM_PROMPT, summarize_faq
...
class TestRegister(unittest.TestCase):
    ...
    def test_manifest_has_required_intent_and_perms(self):
        self.assertIn("faq", AGENT_MANIFEST.required_intents)
        self.assertIn("faq:read", AGENT_MANIFEST.permissions)
        self.assertIn("faq:read", QUERY_TOOL.permissions)
