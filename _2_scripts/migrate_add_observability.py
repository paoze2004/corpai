...
跑法:`uv run python _2_scripts/migrate_add_observability.py`(或 `make migrate-phase4`)
"""
import logging
import os
import sys
...
def main() -> int:
    ...
    ddl_path = Path(__file__).resolve().parents[1] / "_3_sql" / "migrate_add_observability._3_sql"
